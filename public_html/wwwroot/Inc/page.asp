...
'生成上一页下一页链接
    ...
    Response.Write("  total of " & iCount & " records " &  vbCrLf)
    Response.Write(" GO" & "<INPUT CLASS=wenbenkuang TYEP=TEXT NAME=page SIZE=2 Maxlength=5 VALUE=" & page & ">" & "Page"  & vbCrLf & "<INPUT CLASS=go-wenbenkuang type=submit value=GO>")
