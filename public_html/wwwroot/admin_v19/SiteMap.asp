...
<%
admin_name =  Request.ServerVariables("Url")
admin_name=split(admin_name,"/")

Server.ScriptTimeout=50000
url = config("url") & root
xmlDir = root & "/sitemap.xml"
session("server")= url     '你的域名
...
Set objStream = Server.CreateObject("ADODB.Stream")
    ...
    .WriteText=str
    .SaveToFile server.mappath(xmlDir),2 '生成的XML文件名
    .Close
    End With

  Set objStream = Nothing
  If Not Err Then
    Response.Write("<a href='../sitemap.xml' target='_blank'>SiteMap.xml</a>...SiteMap生成成功")
    Response.End
  End If
...
Function Folderpermission(pathName)
        ...
        PathExclusion=Array("\"&admin_name(Ubound(admin_name) - 1)&"","\css","\data","\flash","\images","\Inc","\js","\module","\template","\uploadfile","\bbs\inc","\eInquiry\edg_ok.asp","\Inquiry\dg_ok.asp","\emessage\ely_ok.asp","\message\ly_ok.asp")
...
Function FileExtensionIsBad(sFileName)
        ...
        Extensions = Array("asp","png","jpeg","pdf","ps","html","htm","php","mid","jpg","gif","doc","swf","lrc","txt","shtml","aspx","jsp")
