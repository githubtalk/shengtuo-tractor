...
<!--#include file="../module/home_url.asp" -->
...
%>
<!--#include file="../module/left5.asp" -->
<!--#include file="../module/hot.asp" -->
<%
Template="../template/download.htm" '模版
...
Filen="../download/"&id&".html" '静态存放位置
Call WriteToUTF(content,Filen) '生成静态页
If Not Err Then Response.Write "<a href='"&root&"/download/"&id&".html' target='_blank'>download/"&id&".html</a>...生成成功！</br>"
