...
'=================上传参数设置=======================
filemaxsize=5000*1024'文件大小B为单位500K
filesavepath=""&root&"/uploadfile/download/"'文件保存路径,如果不存在会自动创建
yearmonth=0'在filesavepath目录以下创建以年月 的目录来保存图片文件,如果不创建以年月的目录,则为0
InceptFileType=	"gif,jpg,bmp,jpeg,png,doc,docx,xls,xlsx,ppt,pptx,rar,pdf"	'允许的上传类型	
'===============================================
