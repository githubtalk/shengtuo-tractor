...
<%
dim id,rs,exec,ssfl,rstt,exectt,tt,tt2
...
%>
<!--#include file="../module/shop_point.asp" -->
<!--#include file="../module/left.asp" -->
<!--#include file="../module/hot.asp" -->
<%
Template="../template/showshop.htm" '模版
...
content=Replace(content,"{Lankecms_protitle}",Lankecms_protitle)
content=Replace(content,"{Lankecms_ProductNo}",Lankecms_ProductNo)
content=Replace(content,"{Lankecms_price}",Lankecms_price)
content=Replace(content,"{Lankecms_description2}",Lankecms_description2)
...
Filen="../products/"&id&".html" '静态存放位置
Call WriteToUTF(content,Filen) '生成静态页
If Not Err Then Response.Write "<a href='"&root&"/products/"&id&".html' target='_blank'>products/"&id&".html</a>...生成成功！</br>"
