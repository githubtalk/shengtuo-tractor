...
<title>修改下载</title>
	...
	<script>
		...
		KindEditor.ready(function(K) {
			var editor1 = K.create('textarea[name="ebody"]', {
				cssPath : 'kindeditor_4.1.5/plugins/code/prettify.css',
				uploadJson : 'kindeditor_4.1.5/asp/upload_json.asp',
				fileManagerJson : 'kindeditor_4.1.5/asp/file_manager_json.asp',
				allowFileManager : true,
  ...
  <tr>
    <td height="30" bgcolor="#FFFFFF"><div align="center">
      <table width="100%" border="0" cellpadding="0" cellspacing="1">
        <tr>
          <td height="30" bgcolor="#F7F7F7"><div align="center"><strong>修改下载</strong></div></td>
        </tr>
      </table>
    </div></td>
  </tr>
  <tr>
    <td bgcolor="#FFFFFF"><FORM method="post" name="myform" action="updata_download.asp">
      <table width="100%" border="1" align="center" cellpadding="6" cellspacing="0" bordercolor="#FFFFFF" bgcolor="#F7F7F7">
        <tr>
          <td width="15%" bgcolor="#F7F7F7"><div align="center">下载名称<font color="#FF0000"> (英文)</font></div></td>
        ...
        <tr>
		  ...
		  rsc.open "select * from download_fl order by px_id asc",conn,1,1
		  while not rsc.eof
		  sid = rsc("id")
        ...
        <tr>
          <td width="15%" bgcolor="#F7F7F7"><div align="center">下载介绍<font color="#FF0000"> (英文)</font></div></td>
          <td bgcolor="#F7F7F7">
          <textarea name="body" cols="100" rows="8" style="width:700px;height:350px;visibility:hidden;"><%=replace(rs("body"),"'","&#39;")%></textarea>
          <p>&nbsp;</p>
          </td>
        </tr>
        <tr>
