...
<% 
'修改广告模块
if Request.QueryString("xiugai_flash")="ok" then
id=request.form("id")
...
<table width="95%" border="0" align="center" cellpadding="0" cellspacing="1" bgcolor="#CCCCCC">
  ...
  <tr>
    <td bgcolor="#FFFFFF"><FORM method="post" name="myform" action="xiugai_flash.asp?xiugai_flash=ok">
      <table width="100%" border="1" align="center" cellpadding="6" cellspacing="0" bordercolor="#FFFFFF" bgcolor="#F7F7F7">
        <tr>
          ...
          <input name="title" type="text" value="<%=rs("title")%>" id="title" size="40">
          <input name="id" type="hidden" value="<%=rs("id")%>" size="30"  />
          </td>
        </tr>
        <tr>
          <td width="15%" bgcolor="#F7F7F7"><div align="center">链接地址<font color="#FF0000"></font></div></td>
          <td bgcolor="#F7F7F7"><input name="link" type="text" value="<%=rs("link")%>" id="link" size="40"></td>
        </tr>
        ...
        <tr>
          ...
          <td bgcolor="#F7F7F7"><label>
            <input name="px_id" type="text" value="<%=rs("px_id")%>" id="px_id" size="5">
          数字越小越排前</label></td>
        </tr>
